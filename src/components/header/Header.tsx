...
export const Header = ({ activeTab, setActiveTab, cartCount, currentUser, onLogout }: { activeTab: any, setActiveTab: any, cartCount: any, currentUser: User | null, onLogout: any }) => {
